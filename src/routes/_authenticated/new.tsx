...
function NewDebate() {
  ...
  return (
    <main className="container mx-auto px-4 py-10 max-w-3xl">
      ...
      <p className="text-muted-foreground mb-8">O mediador (IA) vai escrever as regras a partir desta configuração.</p>
        ...
        <Card className="p-6 space-y-4">
          <div className="space-y-2">
            ...
            <Textarea
              ...
              placeholder="Ex: A inteligência artificial vai substituir empregos criativos?"
              value={form.topic}
